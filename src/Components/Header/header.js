        ...
        <div className="collapse navbar-collapse d-flex justify-content-between" >
          ...
          <ul className="navbar-nav mt-2 mt-lg-0">
            ...
            <li className="nav-item ">
              <Link  className="nav-link mainFilms tabc tablinks main" to="/"><i className="fas fa-bars"></i> Main films </Link >
            </li>


            <li className="nav-item">
              <Link activeClassName='active' className="nav-link favoriteFilms tab tablinks favorite" to="/favorite"><i className="fas fa-file"></i> Faforite films</Link >
            </li>
